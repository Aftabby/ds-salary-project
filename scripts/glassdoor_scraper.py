# -*- coding: utf-8 -*-
"""
Credit for the original code goes to Kenarapfaik.
I have made some modifications to the code to make it work for my use case.

Original code can be found at the following:
...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    # Add the --incognito argument to avoid user data directory conflicts
    options.add_argument("--incognito")

    # Explicitly specify the Chrome binary path
    options.binary_location = "/drivers/chrome"
